...
public abstract class PrecompilingCommandLineCompiler extends CommandLineCompiler implements PrecompilingCompiler {
  protected PrecompilingCommandLineCompiler(final String command, final String identifierArg,
      final String[] sourceExtensions, final String[] headerExtensions, final String outputSuffix,
      final boolean libtool, final PrecompilingCommandLineCompiler libtoolCompiler, final boolean newEnvironment,
  ...
  public CompilerConfiguration[] createPrecompileConfigurations(final CompilerConfiguration config,
    ...
    try (final Reader reader = Files.newBufferedReader(prototype)) {
      ...
      throw new BuildException("Error parsing precompiled header protoype: " + prototype.toString() + ":"
          + ex.toString());
    }
